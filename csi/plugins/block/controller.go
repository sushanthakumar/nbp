...
func (p *Plugin) CreateVolume(
	...
	*csi.CreateVolumeResponse, error) {
	...
	return p.VolumeClient.CreateVolume(req)
}
...
func (p *Plugin) DeleteVolume(
	...
	*csi.DeleteVolumeResponse, error) {
	...
	return p.VolumeClient.DeleteVolume(req.VolumeId)
}
...
func (p *Plugin) ControllerPublishVolume(ctx context.Context,
	...
	*csi.ControllerPublishVolumeResponse, error) {
	...
	return p.VolumeClient.ControllerPublishVolume(req)
}
...
func (p *Plugin) ListVolumes(
	...
	*csi.ListVolumesResponse, error) {
	...
	return p.VolumeClient.ListVolumes(req)
}
...
func (p *Plugin) GetCapacity(
	...
	*csi.GetCapacityResponse, error) {
	...
	return common.GetCapacity(p.VolumeClient.Client, ctx, req)
}
...
func (p *Plugin) CreateSnapshot(
	...
	*csi.CreateSnapshotResponse, error) {
	...
	return common.CreateSnapshot(p.VolumeClient.Client, ctx, req)
}
...
func (p *Plugin) DeleteSnapshot(
	...
	*csi.DeleteSnapshotResponse, error) {
	...
	return common.DeleteSnapshot(p.VolumeClient.Client, ctx, req)
}
...
func (p *Plugin) ListSnapshots(
	...
	*csi.ListSnapshotsResponse, error) {
	...
	return common.ListSnapshots(p.VolumeClient.Client, ctx, req)
}